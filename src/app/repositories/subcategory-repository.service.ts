...
import { CollectionReference, DocumentData, Query, collection, collectionGroup, doc, documentId, getFirestore, query, runTransaction, where } from 'firebase/firestore';
